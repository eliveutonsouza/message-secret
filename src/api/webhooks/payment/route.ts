...
export async function POST(request: NextRequest) {
  try {
    ...
    const updatedLetter = await LetterService.updatePaymentStatus(letterId, paymentStatus, paymentId)

    console.log(`Pagamento atualizado para carta ${letterId}: ${paymentStatus}`)
