...
export async function signInWithEmail(formData: FormData) {
  try {
    ...
    const magicLinkUrl = await generateMagicLink(validatedData.email, validatedData.callbackUrl)
...
async function generateMagicLink(email: string, callbackUrl?: string): Promise<string> {
