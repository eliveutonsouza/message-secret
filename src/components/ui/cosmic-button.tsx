...
interface CosmicButtonProps extends ButtonProps {
  variant?: "cosmic" | "cosmic-outline" | "cosmic-ghost" | "cosmic-destructive"
}
...
const CosmicButton = forwardRef<HTMLButtonElement, CosmicButtonProps>(
  ({ className, variant = "cosmic", ...props }, ref) => {
    const variants = {
      ...
      "cosmic-ghost": "text-purple-300 hover:bg-purple-500/10 hover:text-purple-200 bg-transparent border-0",
      "cosmic-destructive":
