        ...
        <Body className="bg-slate-900 text-white font-sans">
          <Container className="mx-auto py-8 px-4 max-w-2xl">
            <Section className="text-center mb-8">
              ...
              <Text className="text-purple-200 text-lg">Bem-vindo à sua jornada através do espaço-tempo!</Text>
            </Section>

            <Section className="bg-slate-800/50 rounded-lg p-6 border border-purple-500/30 mb-6">
              <Heading className="text-xl text-purple-200 mb-4">Olá{name ? `, ${name}` : ""}! ✨</Heading>

              <Text className="text-purple-300 mb-4">
                Que alegria ter você conosco! Agora você pode criar mensagens que transcendem o tempo e conectar
                corações através do universo.
              </Text>
            ...
            <Section className="bg-purple-900/20 rounded-lg p-4 border border-purple-500/20 mb-6">
              <Text className="text-purple-300 text-sm">
                <strong>💡 Dica:</strong> Cada carta cósmica custa apenas R$ 2,99 e permite que você envie mensagens que
                só serão reveladas no momento perfeito!
              </Text>
            </Section>
